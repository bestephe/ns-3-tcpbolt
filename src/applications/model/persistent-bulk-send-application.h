...
#ifndef PERSISTENT_BULK_SEND_APPLICATION_H
#define PERSISTENT_BULK_SEND_APPLICATION_H
 ...
 * \defgroup bulksend PersistentBulkSendApplication
 *
 ...
 */
class PersistentBulkSendApplication : public Application
{
public:
  static TypeId GetTypeId (void);

  PersistentBulkSendApplication ();

  virtual ~PersistentBulkSendApplication ();
...
#endif /* PERSISTENT_BULK_SEND_APPLICATION_H */
